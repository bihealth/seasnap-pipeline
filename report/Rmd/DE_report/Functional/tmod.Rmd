...
tmp <- subset(file_tab, step=="contrast" & extension == "rds")
...
tmodPanelPlot(resU2, filter.rows.pval=conf.snip$fig_qval_max, pval.thr=conf.snip$fig_qval_max, 
...
\n```{r fig.width=3 + 5 * length(glU), fig.height=3 + 4 * n}
